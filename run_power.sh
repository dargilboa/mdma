...
python3 UCI_density_estimation.py --dataset "power" --lr .1 --m 5 --l 6 --n 200 --r 100 --batch_size 2000 --patience 200 --l2=0.0 --epochs 1000 --use_tb 1 -ce 200 -save_checkpoints 1
