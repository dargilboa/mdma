...
python3 UCI_density_estimation.py --dataset "power" --type "TenNet" --use_HT 0 --lr .1 --m 3 --L 2 --n 1000 --batch_size 2000 --patience 2000 --n_epochs 1000 --use_tb 1 -ce 200 -ve 40 -save_checkpoints 1
