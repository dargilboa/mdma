...
python3 UCI_density_estimation.py --dataset "power" --lr .1 --m 3 --L 2 --n 100 --batch_size 500 --patience 2000 --n_epochs 1000 --use_tb 1 -ce 200 -ve 200 -save_checkpoints 1 --use_MERA 1
